...
namespace XmlSerializer{
	public static class XmlSerializerExtensions{
		...
		/// <summary>
		/// This is the heart of the XMLSerializor, along with DeserializeFromXml.
		/// </summary>
		/// <param name="o">The object (as an extension) that will be Serialized to an XElement</param>
		/// <param name="rootName">The name of root tag of the return xml</param>
		/// <returns>And XML element which represents the passed in object as an XElement</returns>
		...
		/// <summary>
		/// Again, this is the heart of the XMLSerializor, only this piece does the duel of SerializeToXml
		/// </summary>
		/// <param name="x">The Xml node (as an extension) to pass in and turn into an object</param>
		/// <param name="a">The assembly that contains the appropiate classes to properly decode the xml.</param>
		/// <returns>An object in assembly generated from the incoming xml</returns>
